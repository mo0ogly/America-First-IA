"""
Shared helpers for the 4 Chapter VI sub-chapter generators (Trilingual).
...
log = logging.getLogger("chap6_helpers")
...
LABELS = {
    "EN": {
        ...
        "author_info": "Paris - February 2026 | 7 Chapters | 4 Prospective Scenarios | 3 Geographic Zones",
    ...
    "FR": {
        ...
        "author_info": "Paris - fevrier 2026  |  7 chapitres  |  4 scenarios prospectifs  |  3 zones geographiques",
    ...
    "PT-BR": {
        ...
        "author_info": "Paris - fevereiro 2026 | 7 Capitulos | 4 Cenarios Prospectivos | 3 Zonas Geograficas",
...
def add_cover(doc, lang: str, *, chapter_label: str, chapter_subtitle: str):
    """Render the Chapter VI sub-chapter cover."""
