...
BR = LangPack(
    ...
    sections=[
        ...
        ("6.5 Sintese: a Franca diante de tres futuros", [
            ...
            "Configuracao 2: Hub de Energia e Aplicacao (cenario C). A Franca explora sua vantagem nuclear para se tornar o centro de gravidade energetico para IA na Europa. A Mistral Compute e as Gigafactories fornecem computacao local competitiva para inferencia e ajuste fino. As empresas francesas sao soberanas na aplicacao, mas dependentes do hardware dos EUA. Na computacao bruta, a razao EUA/UE cai de 17,6:1 em 2025 para 8-10:1 em 2030; no CACI Power Mode, a lacuna fecha de 3,46:1 para 2,0-2,5:1. A fuga de cerebros e retardada pela existencia de um ecossistema local atraente.",
