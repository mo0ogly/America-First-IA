...
ENDPOINTS_2024 = [
    ("USA",       39.6, 3.5, 1.0,  85, 28.0, 84.0, 0.30, 0.0, 4.2),
    ("Chine",      0.4, 4.8, 0.2,  92, 17.7, 12.5, 0.50, 1.0, 2.0),
    ("Allemagne",  0.5, 1.9, 1.0, 140,  4.5, 53.6, 0.55, 0.0, 1.6),
    ("France",     2.4, 1.5, 1.0, 115,  3.0, 44.4, 0.55, 0.0, 2.0),
    ("UK",         1.2, 1.8, 1.0, 190,  3.4, 50.0, 0.45, 0.0, 1.8),
    ("Japon",      1.1, 2.2, 1.0, 165,  4.2, 33.6, 0.40, 0.0, 2.4),
    ("Coree",      1.0, 1.4, 1.0, 110,  1.7, 33.0, 0.40, 0.0, 2.7),
    ("Inde",       1.8, 5.5, 0.6,  88,  3.5,  2.5, 0.50, 0.5, 1.9),
    ("Canada",     0.6, 0.7, 1.0,  98,  2.1, 53.8, 0.40, 0.0, 2.1),
    ("Pays-Bas",   0.4, 0.5, 1.0, 145,  1.1, 62.7, 0.50, 0.0, 2.0),
    ("Suede",      0.3, 0.3, 1.0,  68,  0.6, 57.7, 0.45, 0.0, 2.6),
    ("Bresil",     0.15, 0.5, 0.6,  78,  2.1,  9.7, 0.45, 0.5, 1.4),
]
