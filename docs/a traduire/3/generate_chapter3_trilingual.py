...
Key revisions vs the previous version (April 2026 dashboard alignment):
    ...
    2. Section 3.3.1 (regional shares): updated to USA 78.9 / China 12.8
...
PT.sections = [
    ...
    ("3.3.1 Dominancia americana: tres quartos do compute operacional", [
        ...
        f"O resultado e inequivoco. Apenas no compute operacional, os Estados Unidos concentram 78,9 por cento da capacidade global em H100-equivalentes, a China detem 12,8 por cento, e a UE(13) representa 4,4 por cento. Os paises restantes somam aproximadamente 6 por cento. A razao operacional EUA/UE em H100-equivalentes e portanto {fmt_fr(us_eu_raw, 1)}:1, uma diferenca de magnitude consideravel que se ampliou ligeiramente desde o snapshot GeoCoded/Sanchez de maio de 2025 (74,5 / 14,1 / 4,8 por cento).[12]",
